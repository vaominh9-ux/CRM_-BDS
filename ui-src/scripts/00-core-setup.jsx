    ...
    const PAGE_META = {
      ...
      leads:        { label:'Tiềm năng',            icon:'fa-user-tag',           group:'CRM' },
      followups:    { label:'Chăm sóc',             icon:'fa-bell',               group:'CRM' },
    ...
    function BottomNavigation({ activeMenu, setActiveMenu, perms, setShowMobileSidebar, pinnedTabs = [] }) {
      const shortLabel = (k) => {
        ...
        if (k === 'leads') return 'Tiềm năng';
        if (k === 'followups') return 'Chăm sóc';
